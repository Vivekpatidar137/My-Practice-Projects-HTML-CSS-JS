const quizArray = [
  {
    question:
      "Which among the following is related to Mesopotamian Civilization?",

    options: ["Iraq", " Egypt", "China", "Greek"],
...

  {
    ...
    options: ["New Delhi", "Mumbai", "Indore", "Lucknow"],
...

  {
    ...
    options: ["Meteors", "Asteroids", "Dwarf stars", "Pulsar"],
  ...
  {
    question:
      "In a Cricket World Cup match, who has scored the maximum runs in one inning?",

    options: ["Chris Gayle", "Martin Guptill", "Virat Kohli", "AB de Villiers"],
